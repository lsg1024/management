package com.moblie.management.factory.service;
...
import static com.moblie.management.factory.excel.ExcelFactory.formatFactoryExcelData;
import static com.moblie.management.utils.ExcelSheetUtil.getSheets;
...
public class FactoryService {
    ...
    public List<String> createAutoFactory(MultipartFile file) throws IOException {
        ...
        formatFactoryExcelData(workSheet, factoryInfo);
